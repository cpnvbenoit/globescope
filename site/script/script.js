...
function actualiser(){
 ...
 if (identifiant == "") {
  ...
  document.getElementById("bouton_poster_perso").innerHTML = '<div class="bouton_download_poster" onclick="posterFormulaire()"><a href="#" class="bouton_download_poster_p"><img src="../images/telecharger_bouton.PNG" alt="Telecharger"></a></div>';
 } else {
